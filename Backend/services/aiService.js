...
async function generateMetadata(fileBuffer) {
  // === MODIFIED PROMPT: 4 EXTRACTED + 2 GENERATED KEYWORDS ===
  const prompt = `Analyze this PDF research paper (including text and visual diagrams/images). 
    ...
    1. Extract Metadata:
       ...
       - Keywords: List of EXACTLY 6 strings.
         * The first 4 keywords must be terms found explicitly in the paper.
         * The last 2 keywords must be generated by you (broader themes or inferred topics).
...
exports.analyzeDocument = async (fileBuffer) => {
  try {
    ...
    console.log(`[AI Service] Text parsed (${rawText.length} chars). Executing Hybrid Analysis (4 Extracted + 2 Gen Keywords)...`);
