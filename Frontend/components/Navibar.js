    ...
    <nav style={navStyle} className="sticky top-0 z-50 backdrop-blur-md border-b border-gray-200/50 transition-all duration-300">
      <div className="container mx-auto px-6">
        <div className="flex justify-between items-center py-4">
          ...
          {/* Brand Logo */}
          <Link href={isPrivileged ? "/admin" : "/"} style={brandStyle} className="hover:opacity-80 flex items-center transition-opacity">
                      ...
                      <div className="border-b border-gray-100 pb-1 mb-1">
                        ...
                        {isAdmin && (
                          <>
                            ...
                            <Link href="/admin/requests?filter=archiving" className="block px-4 py-2 text-sm text-slate-700 hover:bg-slate-50 hover:text-orange-600">Document Archive Requests</Link>
                            <Link href="/admin/archive-requests" className="block px-4 py-2 text-sm text-slate-700 hover:bg-slate-50 hover:text-red-600">User Archive Requests</Link>
                            {isSuperAdmin && (
                      ...
                      <div className="pl-2 mt-2 border-l-2 border-indigo-100">
                        ...
                        {isAdmin && (
                            <>
                                ...
                                <Link href="/admin/users/archivie-requests" className="block py-2 text-slate-600">User Archiving</Link>
                            </>
                        )}
                      </div>
                    )}
