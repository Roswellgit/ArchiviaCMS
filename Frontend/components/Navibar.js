                      ...
                      <div className="border-b border-gray-100 pb-1 mb-1">
                        ...
                        {isAdmin && (
                          <>
                            ...
                            <Link href="/admin/users/archive" className="block px-4 py-2 text-sm text-slate-700 hover:bg-slate-50 hover:text-red-600">User Archiving</Link>
                            {isSuperAdmin && (
                      ...
                      <div className="pl-2 mt-2 border-l-2 border-indigo-100">
                        ...
                        {isAdmin && (
                            <>
                                ...
                                <Link href="/admin/users/archive" className="block py-2 text-slate-600">User Archiving</Link>
                            </>
                        )}
                      </div>
                    )}
